...
impl<U: UnitOfWork> CreateClientUseCase<U> {
    ...
    pub async fn execute(
        ...
        client.created_by = Some(ctx.principal_id.clone());
...
mod tests {
    ...
    fn test_command_serialization() {
        let cmd = CreateClientCommand {
            ...
            description: Some("A test client".to_string()),
        };
    ...
    fn test_client_has_id() {
        ...
        assert_eq!(Client::collection_name(), "clients");
    }
}
