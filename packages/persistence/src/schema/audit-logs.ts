...
export const auditLogs = pgTable(
	"aud_logs",
	{
		...
		// Application and client context (null for platform-internal ops without context)
	...
	(table) => [
		...
		// Index for application/client filtering
		index("idx_aud_logs_application").on(table.applicationId),
		index("idx_aud_logs_client").on(table.clientId),
	],
);
