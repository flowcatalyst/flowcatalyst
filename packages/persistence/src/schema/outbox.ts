 ...
 */
export type NewEventProjectionFeedRecord =
	typeof eventProjectionFeed.$inferInsert;

/**
 * Dispatch job projection feed entity type (select result).
 */
export type DispatchJobProjectionFeedRecord =
	typeof dispatchJobProjectionFeed.$inferSelect;

/**
 * New dispatch job projection feed type (insert input).
 */
export type NewDispatchJobProjectionFeedRecord =
	typeof dispatchJobProjectionFeed.$inferInsert;
