...
export const CLIENT_AUTH_CONFIG_PERMISSIONS = {
	...
	MANAGE: makePermission(
		...
		"client-auth-config",
		"manage",
		"Full client auth config management",
	),
} as const;
