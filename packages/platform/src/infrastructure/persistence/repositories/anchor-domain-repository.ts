...
import type { AnchorDomain, NewAnchorDomain } from "../../../domain/index.js";
...
export interface AnchorDomainRepository {
	...
	): Promise<AnchorDomain | undefined>;
	findByDomain(
		domain: string,
		tx?: TransactionContext,
	): Promise<AnchorDomain | undefined>;
	...
	insert(
		entity: NewAnchorDomain,
		tx?: TransactionContext,
	): Promise<AnchorDomain>;
 ...
 */
export function createAnchorDomainRepository(
	defaultDb: AnyDb,
