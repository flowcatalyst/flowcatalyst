...
export const applicationClientConfigs = pgTable(
	...
	(table) => [
		...
		unique("uq_app_client_configs_app_clt").on(
			table.applicationId,
			table.clientId,
		),
	],
...
export type ApplicationClientConfigRecord =
	typeof applicationClientConfigs.$inferSelect;
export type NewApplicationClientConfigRecord =
	typeof applicationClientConfigs.$inferInsert;
