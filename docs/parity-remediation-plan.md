...
- **Recommended next:** Phase 8 (outbox processor, OB1–OB8 — includes adding a MongoDB outbox backend). Then Phase 9 (MCP), Phase 10 (ops/Docker).
