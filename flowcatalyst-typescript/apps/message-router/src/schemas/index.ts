...
export const OidcDiagnosticsResponseSchema = Type.Object({
	...
	authenticationMode: Type.Union([Type.Literal('NONE'), Type.Literal('BASIC'), Type.Literal('OIDC')]),
	...
	discoveryStatus: Type.Union([Type.Literal('OK'), Type.Literal('ERROR'), Type.Literal('NOT_CONFIGURED')]),
