...
import type { RoleRepository, ApplicationRepository } from '../../infrastructure/persistence/index.js';
 ...
 */
export async function registerSdkRolesRoutes(fastify: FastifyInstance, deps: SdkRolesDeps): Promise<void> {
	const { roleRepository, applicationRepository, createRoleUseCase, updateRoleUseCase, deleteRoleUseCase } = deps;
