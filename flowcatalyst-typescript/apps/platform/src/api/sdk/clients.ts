 ...
 */
export async function registerSdkClientsRoutes(fastify: FastifyInstance, deps: SdkClientsDeps): Promise<void> {
	const { clientRepository, createClientUseCase, updateClientUseCase, changeClientStatusUseCase, deleteClientUseCase } =
		deps;
