...
export interface ServiceAccountsRoutesDeps {
	...
	readonly regenerateSigningSecretUseCase: UseCase<RegenerateSigningSecretCommand, SigningSecretRegenerated>;
	readonly assignServiceAccountRolesUseCase: UseCase<AssignServiceAccountRolesCommand, RolesAssigned>;
}
