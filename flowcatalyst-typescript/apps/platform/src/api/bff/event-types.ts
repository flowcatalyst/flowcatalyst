...
import type { EventTypeRepository, EventTypeFilters } from '../../infrastructure/persistence/index.js';
...
function toBffSpecVersion(sv: SpecVersion): BffSpecVersion {
	return {
		...
		...(sv.schemaContent !== null ? { schema: typeof sv.schemaContent === 'string' ? sv.schemaContent : JSON.stringify(sv.schemaContent) } : {}),
