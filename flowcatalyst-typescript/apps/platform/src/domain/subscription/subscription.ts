...
export function updateSubscription(
	...
	return {
		...
		...(updates.dispatchPoolCode !== undefined ? { dispatchPoolCode: updates.dispatchPoolCode } : {}),
		...
		...(updates.serviceAccountId !== undefined ? { serviceAccountId: updates.serviceAccountId } : {}),
