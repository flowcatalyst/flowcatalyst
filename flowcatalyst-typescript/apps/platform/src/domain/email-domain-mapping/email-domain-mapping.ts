...
export type NewEmailDomainMapping = Omit<EmailDomainMapping, 'createdAt' | 'updatedAt'> & {
	createdAt?: Date;
	updatedAt?: Date;
};
...
export function updateEmailDomainMapping(
	...
	return {
		...mapping,
		...(updates.identityProviderId !== undefined ? { identityProviderId: updates.identityProviderId } : {}),
		...(updates.scopeType !== undefined ? { scopeType: updates.scopeType } : {}),
		...(updates.primaryClientId !== undefined ? { primaryClientId: updates.primaryClientId } : {}),
		...(updates.additionalClientIds !== undefined ? { additionalClientIds: updates.additionalClientIds } : {}),
		...(updates.grantedClientIds !== undefined ? { grantedClientIds: updates.grantedClientIds } : {}),
		...(updates.requiredOidcTenantId !== undefined ? { requiredOidcTenantId: updates.requiredOidcTenantId } : {}),
		...(updates.allowedRoleIds !== undefined ? { allowedRoleIds: updates.allowedRoleIds } : {}),
		...(updates.syncRolesFromIdp !== undefined ? { syncRolesFromIdp: updates.syncRolesFromIdp } : {}),
	};
}
 ...
 */
export function getMappingAccessibleClientIds(mapping: EmailDomainMapping): string[] {
