...
export { type UserIdentity, createUserIdentity, extractEmailDomain } from './user-identity.js';

export { type RoleAssignment, createRoleAssignment } from './role-assignment.js';
