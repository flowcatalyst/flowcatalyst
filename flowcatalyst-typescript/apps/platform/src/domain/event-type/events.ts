...
export class EventTypeCreated extends BaseDomainEvent<EventTypeCreatedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'created');
		...
		super(
			{
				...
				messageGroup: DomainEvent.messageGroup(APP, 'event-type', data.eventTypeId),
			},
			ctx,
			data,
		);
...
export class EventTypeUpdated extends BaseDomainEvent<EventTypeUpdatedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'updated');
	static readonly SPEC_VERSION = '1.0';
...
export class EventTypeArchived extends BaseDomainEvent<EventTypeArchivedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'archived');
	static readonly SPEC_VERSION = '1.0';
...
export class EventTypeDeleted extends BaseDomainEvent<EventTypeDeletedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'deleted');
	static readonly SPEC_VERSION = '1.0';
...
export class SchemaAdded extends BaseDomainEvent<SchemaAddedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'schema-added');
	static readonly SPEC_VERSION = '1.0';
...
export class SchemaFinalised extends BaseDomainEvent<SchemaFinalisedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'schema-finalised');
	static readonly SPEC_VERSION = '1.0';
...
export class SchemaDeprecated extends BaseDomainEvent<SchemaDeprecatedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'schema-deprecated');
	static readonly SPEC_VERSION = '1.0';
...
export class EventTypesSynced extends BaseDomainEvent<EventTypesSyncedData> {
	static readonly EVENT_TYPE = DomainEvent.eventType(APP, DOMAIN, 'event-type', 'synced');
	static readonly SPEC_VERSION = '1.0';
		...
		super(
			{
				...
				messageGroup: DomainEvent.messageGroup(APP, 'event-type', data.applicationCode),
			},
			ctx,
			data,
		);
