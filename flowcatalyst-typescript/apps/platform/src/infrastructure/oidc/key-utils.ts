 ...
 */
export async function generateKeyPair(): Promise<{ kid: string; privatePem: string; publicPem: string }> {
 ...
 */
export async function writeKeyPair(dir: string, kid: string, privatePem: string, publicPem: string): Promise<void> {
