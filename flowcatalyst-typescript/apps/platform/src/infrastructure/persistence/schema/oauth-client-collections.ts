...
export const oauthClientRedirectUris = pgTable(
	...
	{
		oauthClientId: tsidColumn('oauth_client_id').notNull().references(() => oauthClients.id, { onDelete: 'cascade' }),
...
export type OAuthClientRedirectUriRecord = typeof oauthClientRedirectUris.$inferSelect;
export type NewOAuthClientRedirectUriRecord = typeof oauthClientRedirectUris.$inferInsert;
...
export type OAuthClientAllowedOriginRecord = typeof oauthClientAllowedOrigins.$inferSelect;
export type NewOAuthClientAllowedOriginRecord = typeof oauthClientAllowedOrigins.$inferInsert;
...
export type OAuthClientGrantTypeRecord = typeof oauthClientGrantTypes.$inferSelect;
export type NewOAuthClientGrantTypeRecord = typeof oauthClientGrantTypes.$inferInsert;
...
export type OAuthClientApplicationIdRecord = typeof oauthClientApplicationIds.$inferSelect;
export type NewOAuthClientApplicationIdRecord = typeof oauthClientApplicationIds.$inferInsert;
