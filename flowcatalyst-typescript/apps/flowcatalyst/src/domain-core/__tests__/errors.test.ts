...
describe("UseCaseError", () => {
	describe("validation", () => {
		it("should create a validation error", () => {
			const error = UseCaseError.validation(
				"INVALID_EMAIL",
	...
	describe("notFound", () => {
		it("should create a not found error", () => {
			const error = UseCaseError.notFound(
	...
	describe("businessRule", () => {
		it("should create a business rule violation", () => {
			const error = UseCaseError.businessRule(
				"ALREADY_ARCHIVED",
	...
	describe("concurrency", () => {
		it("should create a concurrency error", () => {
			const error = UseCaseError.concurrency(
				"VERSION_CONFLICT",
	...
	describe("isUseCaseError", () => {
		it("should return true for valid use case errors", () => {
			expect(
				UseCaseError.isUseCaseError(UseCaseError.validation("CODE", "msg")),
			).toBe(true);
			expect(
				UseCaseError.isUseCaseError(UseCaseError.notFound("CODE", "msg")),
			).toBe(true);
			expect(
				UseCaseError.isUseCaseError(UseCaseError.businessRule("CODE", "msg")),
			).toBe(true);
			expect(
				UseCaseError.isUseCaseError(UseCaseError.concurrency("CODE", "msg")),
			).toBe(true);
		});
		...
		it("should return false for objects with missing fields", () => {
			...
			expect(
				UseCaseError.isUseCaseError({ type: "validation", code: "X" }),
			).toBe(false);
			expect(UseCaseError.isUseCaseError({ code: "X", message: "Y" })).toBe(
				false,
			);
		});
	});
