...
describe("DomainEvent", () => {
	...
	describe("subject", () => {
		it("should create subject string", () => {
			const subject = DomainEvent.subject(
				"platform",
				"eventtype",
				"0HZXEQ5Y8JY5Z",
			);
	...
	describe("messageGroup", () => {
		it("should create message group string", () => {
			const group = DomainEvent.messageGroup(
				"platform",
				"eventtype",
				"0HZXEQ5Y8JY5Z",
			);
	...
	describe("extractAggregateType", () => {
		it("should extract aggregate type from subject", () => {
			expect(
				DomainEvent.extractAggregateType("platform.eventtype.123456789"),
			).toBe("Eventtype");
			expect(
				DomainEvent.extractAggregateType("platform.user-account.abc"),
			).toBe("Useraccount");
		});
	...
	describe("extractEntityId", () => {
		it("should extract entity ID from subject", () => {
			expect(DomainEvent.extractEntityId("platform.eventtype.123456789")).toBe(
				"123456789",
			);
		});
