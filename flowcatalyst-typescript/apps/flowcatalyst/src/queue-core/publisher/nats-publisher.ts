...
import { connect, type NatsConnection, type JetStreamClient, headers } from 'nats';
...
export async function createNatsPublisher(config: NatsPublisherConfig): Promise<QueuePublisher> {
