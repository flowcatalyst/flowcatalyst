...
export type EmbeddedPublishFn = (message: {
  ...
  payload: unknown;
}) => { success: boolean; error?: string | undefined; deduplicated?: boolean | undefined };

export function createEmbeddedPublisher(publishFn: EmbeddedPublishFn): QueuePublisher {
