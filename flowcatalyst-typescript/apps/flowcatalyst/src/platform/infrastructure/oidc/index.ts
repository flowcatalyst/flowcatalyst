...
export { createFindAccount, createAccountAdapter, type AccountAdapter } from './account-adapter.js';
...
export { registerOidcFederationRoutes, type OidcFederationDeps } from './oidc-federation-routes.js';
...
export { createOrUpdateOidcUser, syncIdpRoles, extractIdpRoles } from './oidc-sync-service.js';
