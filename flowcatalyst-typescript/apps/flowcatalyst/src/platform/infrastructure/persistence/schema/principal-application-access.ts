...
export const principalApplicationAccess = pgTable(
	...
	(table) => [
		...
		index("idx_iam_principal_app_access_app_id").on(table.applicationId),
	],
);

// Type inference
export type PrincipalApplicationAccessRecord =
	typeof principalApplicationAccess.$inferSelect;
export type NewPrincipalApplicationAccessRecord =
	typeof principalApplicationAccess.$inferInsert;
