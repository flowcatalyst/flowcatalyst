...
export interface ClientAuthConfigRepository {
	...
	insert(
		entity: NewClientAuthConfig,
		tx?: TransactionContext,
	): Promise<ClientAuthConfig>;
	update(
		entity: ClientAuthConfig,
		tx?: TransactionContext,
	): Promise<ClientAuthConfig>;
	persist(
		entity: NewClientAuthConfig,
 ...
 */
export function createClientAuthConfigRepository(
	defaultDb: AnyDb,
 ...
 */
function recordToClientAuthConfig(
	record: ClientAuthConfigRecord,
): ClientAuthConfig {
	return {
		id: record.id,
