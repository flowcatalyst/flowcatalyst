...
export const CLIENT_ACCESS_PERMISSIONS = {
	GRANT: makePermission(
		SUBDOMAIN,
		CONTEXT,
		"client-access",
		"grant",
		"Grant client access to users",
	),
	REVOKE: makePermission(
		SUBDOMAIN,
		CONTEXT,
		"client-access",
		"revoke",
		"Revoke client access from users",
	),
	READ: makePermission(
		SUBDOMAIN,
		CONTEXT,
