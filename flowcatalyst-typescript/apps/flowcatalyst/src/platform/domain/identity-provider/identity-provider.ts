...
export type NewIdentityProvider = Omit<
	IdentityProvider,
	"createdAt" | "updatedAt"
> & {
	createdAt?: Date;
 ...
 */
export function getEffectiveIssuerPattern(
...
export function updateIdentityProvider(
	...
	return {
		...
		...(updates.oidcIssuerUrl !== undefined
			? { oidcIssuerUrl: updates.oidcIssuerUrl }
			: {}),
		...(updates.oidcClientId !== undefined
			? { oidcClientId: updates.oidcClientId }
			: {}),
		...(updates.oidcClientSecretRef !== undefined
			? { oidcClientSecretRef: updates.oidcClientSecretRef }
			: {}),
		...(updates.oidcMultiTenant !== undefined
			? { oidcMultiTenant: updates.oidcMultiTenant }
			: {}),
		...(updates.oidcIssuerPattern !== undefined
			? { oidcIssuerPattern: updates.oidcIssuerPattern }
			: {}),
		...(updates.allowedEmailDomains !== undefined
