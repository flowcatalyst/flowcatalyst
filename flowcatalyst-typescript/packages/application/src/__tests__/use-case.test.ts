...
describe('UseCase Pattern', () => {
  ...
  it('should return success when valid command', async () => {
    ...
    const result = await useCase.execute({ email: 'user@example.com', name: 'Test User' }, ctx);
  ...
  it('should return validation error for missing name', async () => {
    ...
    const result = await useCase.execute({ email: 'user@example.com', name: '' }, ctx);
  ...
  it('should return validation error for invalid email', async () => {
    ...
    const result = await useCase.execute({ email: 'invalid-email', name: 'Test' }, ctx);
  ...
  it('should return business rule error for duplicate email', async () => {
    ...
    const result = await useCase.execute({ email: 'user@example.com', name: 'Test' }, ctx);
