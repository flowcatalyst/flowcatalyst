...
describe('AuditContext', () => {
  ...
  describe('runWithPrincipalAsync', () => {
    const testPrincipal = AuditContext.createPrincipal('principal-async', 'USER', 'ANCHOR', null, [
      'admin',
    ]);
  ...
  describe('authorization checks', () => {
    ...
    describe('hasRole', () => {
      it('should return true when principal has role', () => {
        const principal = AuditContext.createPrincipal('p1', 'USER', 'CLIENT', 'c1', [
          'admin',
          'viewer',
        ]);
  ...
  describe('createPrincipal', () => {
    it('should create principal with all fields', () => {
      const principal = AuditContext.createPrincipal('id-1', 'SERVICE', 'PARTNER', 'client-x', [
        'role1',
        'role2',
      ]);
