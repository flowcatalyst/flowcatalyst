...
-- +goose Down
DROP INDEX IF EXISTS idx_portal_identities_client_name_prefix;
DROP INDEX IF EXISTS idx_portal_identities_client_email_prefix;
ALTER TABLE portal_identities DROP COLUMN IF EXISTS invite_expires_at;
ALTER TABLE portal_identities DROP COLUMN IF EXISTS invited_at;
ALTER TABLE oauth_clients DROP COLUMN IF EXISTS portal_app_id;
DROP INDEX IF EXISTS idx_portal_identity_apps_app;
DROP TABLE IF EXISTS portal_identity_apps;
